...
import org.test.week06lab01.Tropel.domain.Tropel;
import org.test.week06lab01.Tropel.domain.Role;
import org.test.week06lab01.Tropel.infrastructure.AccountRepository;
...
public class AuthService {
    ...
    public TokenResponse signUp(SignUpRequest request){
        Tropel account = accountRepository.save(
                new Tropel(
                        request.getEmail(),
